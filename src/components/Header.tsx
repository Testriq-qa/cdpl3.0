        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900">TechEd Pro</span>
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="py-2">
                  <Link href="/courses/software-testing" className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                    <Code className="h-4 w-4 mr-2" />
                    Software Testing
                  </Link>
                  <Link href="/courses/data-science" className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                    <Database className="h-4 w-4 mr-2" />
                    Data Science
                  </Link>
                  <Link href="/courses/ai-ml" className="flex items-center px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600">
