...
export const BlogPostHeroSection: React.FC = () => {
    ...
    return (
        <section className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-10">
            {/* Title */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center mb-6 sm:mb-8 space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <div className="text-center sm:text-left">
                    <p className="font-semibold text-base sm:text-lg">Connor Gillivan</p>
