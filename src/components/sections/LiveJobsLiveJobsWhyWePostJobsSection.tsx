// components/Sections/CDPLWhyWePostJobsSection.tsx
"use client";
...
/**
 * CDPLWhyWePostJobsSection
 * Non-hero typography aligned to MentorOutcomesSection:
 * - H2: text-3xl sm:text-4xl font-extrabold
 * - Lead: text-[15px] sm:text-base
 * - KPI numbers: text-xl font-extrabold
 * - Cards title: text-[16px] font-extrabold
 * - Body: text-[13.5px]
...
export default function JobsLiveJobsWhyWePostJobsSection() {
    ...
    return (
        <section
            aria-labelledby="why-cdpl-posts-jobs"
            className="relative overflow-hidden bg-white"
        >
            {/* Brand wash + integrated radial flare */}
            <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
                <div
                    className="absolute inset-0"
                    style={{
                        background:
                            "linear-gradient(120deg, rgba(125,211,252,.18), rgba(157,123,255,.16))",
                    }}
                />
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(closest-side, rgba(255,140,0,.20), rgba(255,140,0,0))",
                    }}
                />
            </div>
            ...
            <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
                ...
                <div className="max-w-3xl">
                    ...
                    >
                        ...
                        >
                            verified nearby jobs
                        </span>{" "}
                        for students
                    </h2>
                    <p className="mt-3 text-[15px] text-slate-700 sm:text-base">
                        ...
                        <strong className="text-slate-900">DevOps</strong>, and pairs them
                        with mentor guidance and hiring-partner referrals—so you can apply
                        confidently and get to interview faster.
                    </p>
                </div>
                    ...
                    {[
                        ...
                        >
                            <div
                                ...
                                style={{
                                    background:
                                        "linear-gradient(90deg, #ff8c00, #ffd19e)",
                                }}
                            />
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    ...
                                    style={{
                                        background:
                                            "linear-gradient(180deg, rgba(255,140,0,.08), rgba(255,140,0,0))",
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <h3 className="text-[16px] font-extrabold leading-snug text-slate-900">
                                            {title}
                                        </h3>
