          ...
          <div className="relative grid gap-6 p-5 sm:grid-cols-12 sm:p-6 lg:gap-8 lg:p-8">
            ...
            <div className="sm:col-span-8">
              <div className="mb-2 inline-flex items-center gap-2">
                ...
                <h3
                  id="wa-jobs"
                  className="text-[1.75rem] font-bold tracking-tight text-slate-900"
                >
                  CDPL job alerts on WhatsApp
                </h3>
              </div>
            ...
            <div className="sm:col-span-4 flex flex-col items-stretch justify-center sm:items-end">
              <a
                ...
                className="inline-flex items-center justify-center whitespace-nowrap gap-2 rounded-xl px-4 py-2.5 text-sm sm:text-base font-semibold text-white shadow-sm transition-transform hover:-translate-y-[1px] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-orange-300"
                style={{
                  background:
                    "linear-gradient(90deg, var(--color-brand, #ff8c00), #ffa64d 55%, #ffc178)",
                }}
