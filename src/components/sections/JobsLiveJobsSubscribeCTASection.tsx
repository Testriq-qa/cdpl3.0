          ...
          <div className="relative grid gap-6 p-5 sm:grid-cols-12 sm:p-6 lg:gap-8 lg:p-8">
            ...
            <div className="sm:col-span-8">
              <div className="mb-2 inline-flex items-center gap-2">
                ...
                <h3 id="wa-jobs" className="text-lg font-extrabold leading-tight text-slate-900 sm:text-xl">
                  Get CDPL job alerts on WhatsApp
                </h3>
              </div>

              <p className="max-w-2xl text-[14.5px] text-slate-600 sm:text-base">
            ...
            <div className="sm:col-span-4 flex flex-col items-stretch justify-center sm:items-end">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-transform hover:-translate-y-[1px] hover:shadow-md focus:outline-none focus:ring-2 focus:ring-orange-300"
                style={{ background: "linear-gradient(90deg,#ff8c00, #ffb558 55%, #ffd19e)" }}
                aria-label="Join CDPL WhatsApp Channel (opens in WhatsApp)"
              >
                <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true" className="mr-2">
