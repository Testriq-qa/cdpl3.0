...
export const BlogPostSection: React.FC = () => {
    return (
        <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
            <main className="lg:col-span-2">
                {/* Table of Contents */}
                <h2 className="text-2xl sm:text-3xl font-bold mb-4">Table of Contents</h2>
                <ul className="list-decimal pl-4 sm:pl-6 mb-8 sm:mb-12 space-y-2 text-sm sm:text-base">
                    {[
                ...
                {/* Step 1 */}
                <h2 id="step1" className="text-2xl sm:text-3xl font-bold mb-4">1. Title: Include keyword + SERP research</h2>
                ...
                <blockquote className="border-l-4 border-blue-600 pl-4 italic mb-8 text-sm sm:text-base">
                    “Today it’s not about ‘get the traffic, it’s about ‘get the targeted and relevant traffic.’” - Adam Audette
                </blockquote>

                {/* Step 2 */}
                <h2 id="step2" className="text-2xl sm:text-3xl font-bold mb-4">2. Author Bio showing E-E-A-T</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 3 */}
                <h2 id="step3" className="text-2xl sm:text-3xl font-bold mb-4">3. Images: 5+ w/ metadata</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 4 */}
                <h2 id="step4" className="text-2xl sm:text-3xl font-bold mb-4">4. Links: 5+ internal + external</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 5 */}
                <h2 id="step5" className="text-2xl sm:text-3xl font-bold mb-4">5. 1500+ words/blog post based on SERP</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 6 */}
                <h2 id="step6" className="text-2xl sm:text-3xl font-bold mb-4">6. Table of Contents: Easily Jump Around!</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 7 */}
                <h2 id="step7" className="text-2xl sm:text-3xl font-bold mb-4">7. E-E-A-T: Show off expertise in the content</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 8 */}
                <h2 id="step8" className="text-2xl sm:text-3xl font-bold mb-4">8. CTAs: In content, sidebar, conclusion</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 9 */}
                <h2 id="step9" className="text-2xl sm:text-3xl font-bold mb-4">9. Social share buttons</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 10 */}
                <h2 id="step10" className="text-2xl sm:text-3xl font-bold mb-4">10. Top notch quality writing</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 11 */}
                <h2 id="step11" className="text-2xl sm:text-3xl font-bold mb-4">11. URL: Short + includes keyword</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 12 */}
                <h2 id="step12" className="text-2xl sm:text-3xl font-bold mb-4">12. Optimize for mobile experience</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 13 */}
                <h2 id="step13" className="text-2xl sm:text-3xl font-bold mb-4">13. Proper spacing: Make it readable</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 14 */}
                <h2 id="step14" className="text-2xl sm:text-3xl font-bold mb-4">14. Sidebar w/ links + clear Call to Action</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 15 */}
                <h2 id="step15" className="text-2xl sm:text-3xl font-bold mb-4">15. Font: readable + popular for blogs</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 16 */}
                <h2 id="step16" className="text-2xl sm:text-3xl font-bold mb-4">16. Color: Easy on the eyes - #333333</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 17 */}
                <h2 id="step17" className="text-2xl sm:text-3xl font-bold mb-4">17. Exit intent pop up to capture leads</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 18 */}
                <h2 id="step18" className="text-2xl sm:text-3xl font-bold mb-4">18. Proper use of headings (H1, H2, etc.)</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                {/* Step 19 */}
                <h2 id="step19" className="text-2xl sm:text-3xl font-bold mb-4">19. Video embed + infographics</h2>
                <p className="mb-4 text-sm sm:text-base">
                ...
                <blockquote className="border-l-4 border-blue-600 pl-4 italic mb-8 text-sm sm:text-base">
                    “The slower your site’s load, the more visitors and revenue you’ll lose out on.” - Anna Crowe
                </blockquote>

                {/* Step 20 */}
                <h2 id="step20" className="text-2xl sm:text-3xl font-bold mb-4">20. Quotes from SMEs on the topic</h2>
                <p className="mb-4 text-sm sm:text-base">
            ...
            <aside className="mt-6 lg:mt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-col md:gap-4 space-y-6 lg:sticky lg:top-8">
                    ...
                    <div className="bg-gradient-to-br from-blue-100 to-indigo-100 p-4 sm:p-6 rounded-lg shadow-md">
                        ...
                        <div className="space-y-4">
                            <input
                                ...
                                className="w-full px-3 py-2 border border-gray-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-300 ease-in-out"
                            />
                            <button
                                type="submit"
                    ...
                    <div className="bg-gray-100 p-4 sm:p-6 rounded-lg shadow-md text-center">
                        <h3 className="text-lg sm:text-xl font-bold mb-2">Share This Post</h3>
                    ...
                    <div className="bg-gray-100 p-4 sm:p-6 rounded-lg shadow-md">
                        <h3 className="text-lg sm:text-xl font-bold mb-2">Related Articles</h3>
                            ...
                            {Array(3).fill(null).map((_, index) => (
                                <li key={index}>
                                    <Link href="https://www.testriq.com/blog/post/how-to-test-web-applications" className="flex items-center space-x-3 p-2 hover:bg-gray-200 rounded-lg transition-all duration-200">
                                        ...
                                        />
                                        <div>
                                            <p className="font-semibold">What is Software Testing?</p>
                    ...
                    {/* Categories */}
                    <div className="bg-gray-100 p-4 sm:p-6 rounded-lg shadow-md">
                        <h3 className="text-lg sm:text-xl font-bold mb-2">Categories</h3>
                        <ul className="space-y-2 text-xs sm:text-sm">
                            {[
