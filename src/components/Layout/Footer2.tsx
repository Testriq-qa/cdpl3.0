          ...
          <div className="px-6 md:px-10 py-5">
            <div className="flex flex-col md:flex-row items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 text-[11px] text-slate-500">
                <span className="rounded-full bg-slate-100 px-2 py-1">Quality Training</span>
                <span className="rounded-full bg-slate-100 px-2 py-1">Job Assistance</span>
                <span className="rounded-full bg-slate-100 px-2 py-1">Mentor Support</span>
              </div>
            </div>
          </div>
        </div>
