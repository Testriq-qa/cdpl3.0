...
const mockData = {
  whyChooseContent: {
    ...
    subtitle: "Join thousands of successful students who transformed their careers with our proven methodology",
    reasons: [
      {
        icon: "Award",
        title: "Industry Certified",
        stats: "100% Certified",
        description: "Get globally recognized certifications that open doors to top companies worldwide"
      },
      {
        icon: "Users",
        title: "Expert Mentors",
        stats: "50+ Instructors",
        description: "Learn from industry veterans with real-world experience in leading tech companies"
      },
      {
        icon: "Clock",
      ...
      },
      {
        ...
        stats: "80+ Countries",
        description: "Connect with a worldwide network of learners and professionals in your field"
      }
    ],
    testimonial: {
      rating: 5,
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-b from-slate-50 via-white to-slate-50 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/3 -left-20 w-72 h-72 bg-gradient-to-br from-blue-200/30 to-indigo-200/30 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-32 right-1/4 w-96 h-96 bg-gradient-to-br from-violet-200/20 to-purple-200/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {whyChooseContent.reasons.map((reason: any, index: number) => (
            <motion.div
              key={index}
            ...
            >
              <div className="relative h-full bg-white rounded-2xl p-6 sm:p-7 lg:p-8 shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-transparent overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/0 via-teal-50/0 to-blue-50/0 group-hover:from-emerald-50 group-hover:via-teal-50 group-hover:to-blue-50 transition-all duration-500 opacity-0 group-hover:opacity-100"></div>
                
                {/* Animated Border Glow */}
                <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-emerald-100 via-teal-100 to-blue-100 blur-xl opacity-30"></div>
                </div>
                ...
                {/* Corner Accent */}
                <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-emerald-100/20 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            </motion.div>
          ))}
        </motion.div>
        ...
        >
          <div className="relative bg-gradient-to-br from-emerald-600 via-teal-600 to-blue-600 rounded-3xl p-8 sm:p-12 lg:p-16 overflow-hidden shadow-2xl">
            ...
            <div className="absolute inset-0 opacity-10">
              ...
              <div className="absolute bottom-0 left-0 w-48 sm:w-80 h-48 sm:h-80 bg-white rounded-full blur-3xl"></div>
            </div>

            {/* Decorative Elements */}
            <div className="absolute top-8 left-8 w-2 h-2 bg-white/40 rounded-full"></div>
            <div className="absolute top-12 left-16 w-1 h-1 bg-white/40 rounded-full"></div>
            <div className="absolute bottom-8 right-12 w-2 h-2 bg-white/40 rounded-full"></div>
        ...
        >
          {[
            ...
            >
              {/* Hover Background */}
              <div className="absolute inset-0 bg-gradient-to-br from-emerald-50/0 to-teal-50/0 group-hover:from-emerald-50 group-hover:to-teal-50 transition-all duration-500"></div>
              ...
              {/* Corner Decoration */}
              <div className="absolute bottom-0 right-0 w-16 h-16 bg-gradient-to-tl from-emerald-100/30 to-transparent rounded-tl-full opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            </motion.div>
          ))}
        </motion.div>
      </div>
